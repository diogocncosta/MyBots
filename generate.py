...
def Generate_Brain():
    ...
    for keyNeuronSensor in range(3):
        for keyNeuronMotor in range(3,5):
            pyrosim.Send_Synapse(sourceNeuronName=keyNeuronSensor, targetNeuronName=keyNeuronMotor, weight=-1+2*random.random())
